...
include_once __DIR__ . '/../core/tpl/timespent_action.tpl.php';
...
print '<input type="submit" class="button valignmiddle smallonsmartphone" name="assigntaskbutton" value="'.dol_escape_htmltag($titleassigntask).'">';
print '</div>';
