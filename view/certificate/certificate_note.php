...
$permissionnote = $user->rights->dolisirh->certificate->write; // Must be included of actions_setnotes.inc.php
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Certificate"), -1, 'dolisirh@dolisirh');
