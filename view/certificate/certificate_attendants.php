...
/**
 *   	\file       view/certificate/certificate_attendants.php
 *		\ingroup    dolisirh
 *		\brief      Page to add/edit/view certificate_signature
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'certificatesignature'; // To manage different context of search
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
	...
	print dol_get_fiche_head($head, 'attendants', $langs->trans("Certificate"), -1, 'dolisirh@dolisirh');
