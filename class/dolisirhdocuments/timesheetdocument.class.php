...
class TimeSheetDocument extends DoliSIRHDocuments
{
	...
	/**
	 * @var string String with name of icon for timesheetdocument. Must be the part after the 'object_' into object_timesheetdocument.png
	 */
	public $picto = 'timesheetdocument@dolisirh';
