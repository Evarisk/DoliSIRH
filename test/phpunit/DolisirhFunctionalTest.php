...
class DolisirhFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolisirh/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolisirh/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolisirh/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolisirh/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolisirhwidget1', $this->source(), "Box enabled");
	}
