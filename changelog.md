...
#### [Unreleased](https://github.com/Evarisk/DoliSIRH/compare/23.0.0...HEAD)

### [23.0.0](https://github.com/Evarisk/DoliSIRH/compare/1.5.1...23.0.0)

> 7 May 2026

- #656 [TimeSheet] fix: broken lock button condition [`#657`](https://github.com/Evarisk/DoliSIRH/pull/657)
- #643 [ModDolisirh] fix: temporary fix of extrafield task on ticket [`#644`](https://github.com/Evarisk/DoliSIRH/pull/644)
- #633 [Mod] fix: change sql filter for forgeSQLFromUniversalSearchCriteria [`#634`](https://github.com/Evarisk/DoliSIRH/pull/634)
- #626 [TimeSheet] add: conf AllowDifferenceBetweenPassedAndWorkingHours [`#631`](https://github.com/Evarisk/DoliSIRH/pull/631)
- #613 [TimeSheet] fix: missing qty check and fk_user_assign [`#614`](https://github.com/Evarisk/DoliSIRH/pull/614)
- #611 [Hook] fix: missing parseInt and check int + cast [`#612`](https://github.com/Evarisk/DoliSIRH/pull/612)
- Main into Develop [`#608`](https://github.com/Evarisk/DoliSIRH/pull/608)
- Merge pull request from Evarisk/develop [`a93fed0`](https://github.com/Evarisk/DoliSIRH/commit/a93fed04aae091ad5d85296a32792373cbe00e63)
- [CI] add: release workflow + gitattributes export-ignore for clean release zip [`b842356`](https://github.com/Evarisk/DoliSIRH/commit/b8423560a6ff7b9234733fb45eac7599858042df)
- [Mod] chore: release notes 23.0.0 [`e7973ef`](https://github.com/Evarisk/DoliSIRH/commit/e7973ef9d3bac65e11904043ecd0167f98850e8c)
- #584 [TimespentRange] fix: remove dead code [`9131873`](https://github.com/Evarisk/DoliSIRH/commit/9131873880909ecfa3a6fa3ca654c8c172511825)
- [CI] chore: align gitignore with Saturne convention [`41161c0`](https://github.com/Evarisk/DoliSIRH/commit/41161c0fa42faf1a0337e9180cc06e065ebbeb28)
- [Hook] fix: fatal fetch ticket object [`a3a8c5a`](https://github.com/Evarisk/DoliSIRH/commit/a3a8c5ac6b5e786147cd5f9f74069a62b84a6cee)
- [WorkingHours] fix: GETPOST [`b0f05b4`](https://github.com/Evarisk/DoliSIRH/commit/b0f05b4e1b51bacf3255b0302f664f328a51791b)
- #616 [Dashboard] add: name on graph and widgets [`6fe5a0f`](https://github.com/Evarisk/DoliSIRH/commit/6fe5a0f9e261e26b74a6ceb2746dca3ed2fc60e7)
- #627 [TimeSheet] fix: missing function getLabelOfUnit [`069be30`](https://github.com/Evarisk/DoliSIRH/commit/069be30fceb00432d3e7303f4d4b3598592fb65f)
- [Class] core: clean code [`1b41841`](https://github.com/Evarisk/DoliSIRH/commit/1b41841dc6ff263064f1031fda7281ee6eac44ff)
- [Class] core: clean code [`6d94658`](https://github.com/Evarisk/DoliSIRH/commit/6d94658fcf9391e8c71f21c141394ad8f64c0ccf)
- [Mod] add: version number 23.0.0 [`70ed1fd`](https://github.com/Evarisk/DoliSIRH/commit/70ed1fdb7d00ae41de9eb9b7ae9026c776231848)
- [Triggers] fix: PHP 8 warning [`261a17e`](https://github.com/Evarisk/DoliSIRH/commit/261a17ed5e6ba72a4706218c93a5c601446c82f8)
- #584 [TimespentRange] fix: serch_user is not reset [`59ab0ef`](https://github.com/Evarisk/DoliSIRH/commit/59ab0efc0af32bc821a4d2a70b32652e94978ca8)
- [Class] core: clean code [`9dc1534`](https://github.com/Evarisk/DoliSIRH/commit/9dc15349e4da7d9ab3c7dbfda42781ee4649092d)
- [Class] core: clean code [`eaefb4d`](https://github.com/Evarisk/DoliSIRH/commit/eaefb4db111693014c66be8b62e5d91255a8f81c)
- [Timespent] fix:  A non-numeric value encountered [`b3d65b1`](https://github.com/Evarisk/DoliSIRH/commit/b3d65b1bdb44b6ca60a3284a64a0720ba83b3a91)
- [Hook] fix: fatal permission on saturne_show_documents [`096d696`](https://github.com/Evarisk/DoliSIRH/commit/096d69638c4bbbf39ae9a64e8a34ddd60517833b)
- #635 [Index] fix: change sql filter for forgeSQLFromUniversalSearchCriteria [`bb756d1`](https://github.com/Evarisk/DoliSIRH/commit/bb756d18966320ca538c4afff2b0d64c260a098a)
- #609 [RecurringInvoiceStats] fix: fatal [`120c03e`](https://github.com/Evarisk/DoliSIRH/commit/120c03e63a627838078f0043ad99709342caee62)
- [Hook] fix: need to update status task [`3d8cdff`](https://github.com/Evarisk/DoliSIRH/commit/3d8cdff2545b19ce087afbcb0798cc2d6b8ff096)
- [Triggers] fix:  fatal on require function [`22bdf36`](https://github.com/Evarisk/DoliSIRH/commit/22bdf36cef60aeb597afa1d12c00bb86968f60a8)
- Merge pull request #629 from nicolas-eoxia/fix_product_use_units_conf [`4b289f6`](https://github.com/Evarisk/DoliSIRH/commit/4b289f6b279f31adfd5adce5691d1b26a45b5d9a)
- Merge pull request #618 from evarisk-kilyan/fix_remove_dead_code [`df5e129`](https://github.com/Evarisk/DoliSIRH/commit/df5e129307e06dfe7f0009f002913d53e8d9ad16)
- Merge pull request #617 from evarisk-kilyan/add_name_on_graph [`e6b11ba`](https://github.com/Evarisk/DoliSIRH/commit/e6b11bac82dd97406fb35a40acc8c7757afe26aa)
- #584 [TimespentRange] fix: remove name of input to not send useless input in post [`f745e38`](https://github.com/Evarisk/DoliSIRH/commit/f745e380a48cddd3b72b97a2a2f23618abc56a9f)
- Merge pull request #610 from evarisk-kilyan/fix_fatal_stats_recurring_invoice [`e8d5c35`](https://github.com/Evarisk/DoliSIRH/commit/e8d5c35e8e4758eee3183cbd47def5eca5c35799)

#### [1.5.1](https://github.com/Evarisk/DoliSIRH/compare/1.5.0...1.5.1)
...
- 📖 Changelog [`7bded37`](https://github.com/Evarisk/DoliSIRH/commit/7bded3799b2cfc92bd7d0b1029764ec0a1b11dc1)
