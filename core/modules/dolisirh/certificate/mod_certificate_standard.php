...
/**
 *  \file       htdocs/core/modules/dolisirh/certificate/mod_certificate_standard.php
 *  \ingroup    dolisirh
...
class mod_certificate_standard
{
	...
	public function getNextValue($object)
	{
		...
		if ($resql) {
			...
			dol_syslog("mod_certificate_standard::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_certificate_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
